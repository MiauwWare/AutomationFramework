...
public sealed class DisenchantingScript1 : BaseScript
{
    public override string Name => "disenchanting-script-1";

    public override string Description => "Disenchants and opens mailbox";

    private AutomationFramework.Cursor _cursor = new();
    private RectangleF _disenchantButtonBounds = new RectangleF(1830, 868, 279, 21); // Example bounds for the "Disenchant" button
    private RectangleF _mailboxBounds = new RectangleF(1298, 932, 282, 20); // Example bounds for the mailbox
